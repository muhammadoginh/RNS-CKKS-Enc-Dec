...
HD_PWD='/home/moginh/Projects/RNS-CKKS-Enc-Dec/RNS-CKKS-Enc-Dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unified_sampler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unified_sampler.tcl
