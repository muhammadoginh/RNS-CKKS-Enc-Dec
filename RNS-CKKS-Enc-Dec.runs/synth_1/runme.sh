...
HD_PWD='F:/Projects/RNS-CKKS-Enc-Dec/RNS-CKKS-Enc-Dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gaussian_dist.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gaussian_dist.tcl
